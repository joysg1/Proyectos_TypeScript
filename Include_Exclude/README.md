# Configuración Include/Exclude en TypeScript

## Descripción

## Visualizador interactivo para dominar la configuración de Include y Exclude en TypeScript. Aprende patrones avanzados, optimiza tu proyecto y mejora el rendimiento de compilación.

## Características ✨

    6 configuraciones especializadas con ejemplos prácticos

    Demos interactivas y visualización de patrones

    Modo claro/oscuro con diseño Glassmorphism

    Búsqueda en tiempo real y navegación rápida
...
## Cómo usar 🚀
    ...
    Explora las configuraciones haciendo clic en las tarjetas

    Usa la barra de búsqueda para encontrar patrones específicos

    Copia configuraciones directamente al portapapeles

# ArrayMethodsLab - Shift y Unshift

## Aplicación educativa interactiva para aprender sobre los métodos shift() y unshift() en arreglos JavaScript/TypeScript

## Características ✨

    Simulador interactivo de operaciones en arreglos

    Visualización en tiempo real de cambios

    Demo automática con controles personalizables

    Métricas de performance y estadísticas

    Historial completo de operaciones

    Animaciones visuales para mejor comprensión

## Cómo usar 🚀

    Abre index.html en tu navegador

    Usa los botones shift/unshift para manipular el arreglo

    Agrega elementos personalizados

    Configura la demo automática con los controles deslizantes

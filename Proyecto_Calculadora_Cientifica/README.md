...
## Calculadora científica avanzada con funciones matemáticas completas y diseño moderno

## Características ✨

    Operaciones básicas y científicas (trigonométricas, logarítmicas, exponenciales)

    Tema oscuro/claro con persistencia automática

    Historial de cálculos (últimos 10)

    Memoria integrada (MC, MR, M+, M-, MS)
